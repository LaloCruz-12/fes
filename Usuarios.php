      ...
      <div class="modal-dialog">	
        <div class="modal-content">	
          ...
          <div class="modal-body">	
            <form >	
              <fieldset class="Form-AddUser">	

                <div>	

                    <label></label>	
                    <input class="controls" type="texts" placeholder="Nombre"> 	
                </div>	

                <div>	
                    <label ></label>	
                    <input class="controls" type="text" placeholder="Apellido paterno">	
                </div>	

                <div>	

                    <label ></label>	
                    <input class="controls" type="number" placeholder="Número de cuenta">	
                </div>	
                <div>	
                  <label class="controls" >Carrera</label>	
                  <select class="controls" name="genero">	
